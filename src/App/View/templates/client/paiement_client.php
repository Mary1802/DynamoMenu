...
<head>
    ...
    <title>Paiement - Commande #<?php echo str_pad((string) $num_commande, 5, '0', STR_PAD_LEFT); ?> - DynamoMenu</title>
        ...
        <div class="paiement-card">
            ...
            <div class="commande-info">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <h3 style="margin: 0;">Commande #<?php echo str_pad((string) $num_commande, 5, '0', STR_PAD_LEFT); ?></h3>
                ...
                <div class="facture-details">
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value">F-<?php echo str_pad((string) $commande['num_facture'], 4, '0', STR_PAD_LEFT); ?></div>
                        </div>
                        <div class="info-item">
