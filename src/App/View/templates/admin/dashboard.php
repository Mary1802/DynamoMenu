    ...
    <div class="dashboard-shell">
        <main class="dashboard-main">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    <!-- Commandes récentes -->
                    <div class="chart-container chart-container--paired">
                            ...
                            <table class="data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr data-searchable data-search="<?php echo htmlspecialchars(mb_strtolower(($order['nom_client'] ?? '') . ' ' . $order['num_commande'])); ?>">
                                        <td>#<?php echo str_pad((string) $order['num_commande'], 5, '0', STR_PAD_LEFT); ?></td>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="chart-container chart-container--paired">
                        ...
                        <div class="compact-table top-plats-scroll">
                            <table class="data-table">
                                <thead>
                                    <tr>
                                        <th>Plat</th>
