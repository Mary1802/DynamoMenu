...
<div class="chart-container mb-4">
    ...
    <form method="post" class="row g-3 align-items-end menu-add-form" enctype="multipart/form-data">
        ...
        <div class="col-4 col-xl-1">
            <input type="number" name="quantite_boisson" class="form-control" placeholder="Stock" value="50" min="0">
        </div>
        <div class="col-12 col-xl-3">
            <input type="text" name="options_fruits" class="form-control" placeholder="Goûts (ex: Orange,Mangue)" title="Goûts disponibles, séparés par des virgules. Vide = pas de choix goût.">
        </div>
        <div class="col-12 col-xl-3 menu-add-form__actions">
            <div class="menu-add-form__actions-inner">
...
<div class="chart-container">
    ...
    <div class="menu-edit-mobile">
        ...
        <div class="menu-edit-card">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="mb-2">
                    <label class="form-label text-secondary small">Goûts (virgules)</label>
                    <input type="text" name="options_fruits" class="form-control form-control-sm" value="<?php echo htmlspecialchars((string) ($b['options_fruits'] ?? '')); ?>" placeholder="Orange,Mangue,...">
                </div>
    ...
    <div class="table-responsive-wrap menu-edit-desktop">
        <table class="data-table">
            <thead><tr><th>Image</th><th>Nom</th><th>Prix</th><th>Type</th><th>Dosage</th><th>Stock</th><th>Goûts</th><th>Actions</th></tr></thead>
            <tbody>
            <?php foreach ($boissons as $b):
            ...
            <tr>
                ...
                <td><input type="text" name="options_fruits" form="<?php echo $boissonFormId; ?>" class="form-control form-control-sm" value="<?php echo htmlspecialchars((string) ($b['options_fruits'] ?? '')); ?>" placeholder="Orange,Mangue"></td>
                <td class="menu-edit-actions-cell">
                    <div class="menu-edit-actions-inner">
